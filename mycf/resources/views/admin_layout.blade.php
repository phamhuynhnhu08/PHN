...
<!--logo start-->
<div class="brand">
    <a href="{{URL::to('/xinchao')}}" class="logo">
        {{Auth::user()->name}}
    </a>
...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="{{('public/backend/images/nhu.jpg')}}">
                <span class="username">
                    {{Auth::user()->name}}
                	{{-- <?php
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li>
                    <a class="active" href="{{URL::to('/dashboard1')}}">
...
<!-- 
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="{{URL::to('/users')}}">Tất cả users</a></li>
                        <!-- <li><a href="{{URL::to('/manage-order')}}">Quản lý đơn hàng</a></li> -->
                    </ul>
                </li>
