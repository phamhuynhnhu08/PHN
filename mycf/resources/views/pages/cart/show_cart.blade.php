						...
						<tr>
							...
							<td class="cart_quantity">
								<div class="cart_quantity_button">
									...
									<input type="submit" value="Tăng số lượng" name="update_qty" class="btn btn-default btn-sm">
									</form>
								</div>
							</td>
							<td class="cart_total">
					...
					<div class="total_area">
						...
						{{-- 	<a class="btn btn-default update" href="">Update</a> --}}
							  <?php
                                ...
                                <a class="btn btn-danger check_out" href="{{URL::to('/show_checkout')}}">Thanh toán</a>
                                <?php
                            }else{
                                 ?>
                                 
                                 <a class="btn btn-danger check_out" href="{{URL::to('/login-checkout')}}">Thanh toán</a>
                                 <?php 
                             }
                                 ?>
