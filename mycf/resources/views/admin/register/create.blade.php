...
<div class="w3layouts-main">
	...
	?>
		...
		<form action="{{URL::to('/dangky')}}" method="post">
			...
			<input type="text"  class="ggg" name="admin_phone" placeholder="Phone" >
			<input type="text"  class="ggg" name="admin_address" placeholder="Địa chỉ" >
		...
		<h3><a href="{{url('/admin')}}">| Đã có tài khoản : Đăng nhập |</a></h3>
